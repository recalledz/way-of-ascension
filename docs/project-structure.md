...
#### `src/features/combat/ui/combatText.js` - Floating Combat Text
**Purpose**: Listens for combat events and displays floating messages for critical hits and misses.
**Key Functions**: `setupCombatText()`.
**When to modify**: Adjust combat text behavior or styling.
