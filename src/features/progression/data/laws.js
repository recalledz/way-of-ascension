...
export const LAWS = {
  ...
  alchemy: {
    ...
    tree: {
      'basic_alchemy': {name: 'Basic Pill Theory', desc: '+15% alchemy success, +10% pill effects', cost: 10, prereq: null, bonus:{alchemySuccess: 0.15, pillEffect: 0.10}, unlockRecipe: 'meridian_opening_dan'},
      ...
      'pill_mastery': {name: 'Pill Mastery', desc: '+40% pill effectiveness, +20% foundation from pills', cost: 50, prereq: 'qi_condensation', bonus: {pillMult: 0.40, pillFoundation: 0.20}, unlockRecipe: 'insight'},
